...
- The system shall validate payment details using a third-party credit card checker.

---

### FR-8 Ticket Cancellation

- The system shall allow users to cancel booked tickets based on defined rules.

---

### FR-9 Booking State Management
